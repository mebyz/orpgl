...
THREEx.RendererStats	= function (){
	...
	container.style.cssText = 'width:80px;opacity:0.9;cursor:pointer;z-index:999999;position:absolute;top:0px;left:0px;';
	...
	return {
		...
		update: function(webGLRenderer, x,z,imgx,imgz,h,tile){
			// sanity check
			...
			msTexts[i++].textContent = "== Misc =====";
			msTexts[i++].textContent = "X: "	+ x;
			msTexts[i++].textContent = "Z: "	+ z;
			msTexts[i++].textContent = "imgX: "	+ imgx;
			msTexts[i++].textContent = "imgZ: "	+ imgz;
			msTexts[i++].textContent = "Height: "	+ h;
			msTexts[i++].textContent = "Tile: "	+ tile;
		}
	}	
};
